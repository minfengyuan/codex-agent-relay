...
function startCli(stateDir: string, cwd: string, log: string): ChildProcessWithoutNullStreams {
  const child = spawn(process.execPath, [cli], {
    ...
    env: {
      ...process.env,
      GROK_RELAY_STATE_DIR: stateDir,
      GROK_RELAY_GROK_COMMAND: fakeGrok,
      GROK_RELAY_TOTAL_TIMEOUT_MS: "10000",
      GROK_RELAY_CANCEL_GRACE_MS: "100",
      GROK_RELAY_TERM_GRACE_MS: "100",
      FAKE_ACP_MODE: "hang",
      FAKE_ACP_LOG: log,
      XAI_API_KEY: "",
    },
